# python 3.7
"""Contains the discriminator class of StyleGAN2.
...
from .stylegan2_discriminator_network import StyleGAN2DiscriminatorNet

__all__ = ['StyleGAN2Discriminator']


class StyleGAN2Discriminator(BaseDiscriminator):
  """Defines the discriminator class of StyleGAN2."""
