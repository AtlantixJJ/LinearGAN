...
class SynthesisModule(nn.Module):
  ...
  def forward(self, w, generate_feature=False, generate_imgsery=False):
  ...
  def forward_middle(self, w, x, image, index):
    """
  ...
  def forward_multiple(self, w, x, mask, xs, image, index):
    """
    Forward starting from an arbitrary featuremap.
    """
